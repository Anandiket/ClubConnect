...
@media (max-width: 767px) {
  ...
  input[type="file"],
  input[type="time"] {
    margin-bottom: 20px; /* Add margin to input fields for better spacing on mobile */
  }
...
?>
<header>
    <form name="newUser" class="register" action="event.php" method="post" enctype="multipart/form-data">
        <h2><?php echo $is_update ? "Update Event" : "New Event Registration"; ?></h2>
</header>
<div class="container">
    <div id="newUser">
        <!-- New User Profile -->
