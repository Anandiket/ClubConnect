...
<body><center>
<div id="signupContainer" class="flip-animation">
    <form action="process_reset_email.php" method="post">
    <div class="sign"><h1><center>Forgot Password</center></h1></div>
        <?php if(isset($_GET['error'])) { ?>
            <p class="error"><?php echo $_GET['error']; ?></p>
        <?php } ?>
            <label for="email"><b><h2>Email Address</h2></b></label>
            <br>
